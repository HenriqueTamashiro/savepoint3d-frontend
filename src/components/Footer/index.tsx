  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <img src="/assets/img/logo-footer.png" alt="Logo Save Point3D" className={styles.logo} />
        <h2 className={styles.headline}>Continue jogando.<br />Continue colecionando.</h2>
        ...
        <div className={styles.columns}>
          ...
          <div className={styles.column}>
            ...
            <a href="https://instagram.com/savepoint3d" target="_blank" rel="noopener noreferrer">@savepoint3d</a>
            <a href="https://wa.me/5511900000000" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            <a href="mailto:contato@savepoint3d.com.br">contato@savepoint3d.com.br</a>
          </div>
        </div>
