...
export const GlobalStyles = createGlobalStyle`
  :root {
    ...
    --color-ink-clear: ${({ theme }) => theme.colors.inkClearSoft};
    --color-clearAccent: ${({ theme }) => theme.colors.clearAccent};
    --color-accent: ${({ theme }) => theme.colors.accent};
    --color-darkAccent: ${({ theme }) => theme.colors.darkAccent};
    --color-muted: ${({ theme }) => theme.colors.muted};
    --color-muted-dark: ${({ theme }) => theme.colors.mutedDark};
    --color-muted-black: ${({ theme }) => theme.colors.mutedBlack};
